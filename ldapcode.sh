...
yum install -y git
cd /tmp
git clone https://github.com/aliyacodes/NTI-310-pub.git
...
# Lets SELinux know what is going on
...
cp /tmp/NTI-310-pub/config/config.php /etc/phpldapadmin/config.php
...
# Creates group and people sructure base
