...
ldap-auth-config        ldap-auth-config/ldapns/ldap-server     string  ldapi://ldap
...
ldap-auth-config        ldap-auth-config/override       boolean true" > /tmp/ldap_debconf 
